...
DIR=../src/main/java/de/tudortmund/cs/iltis/folalib/io/parser/regex
GRAMMARNAME=RegularExpressionParser.g4
PCKG=de.tudortmund.cs.iltis.folalib.io.parser.regex
