 ...
 * grammar failed.
 */
public class LeftRegularGrammarReader
        implements Reader<
                Grammar<
                        IndexedSymbol,
                        IndexedSymbol,
                        LeftRegularProduction<IndexedSymbol, IndexedSymbol>>> {

    private GrammarReaderProperties properties;

    public LeftRegularGrammarReader(GrammarReaderProperties properties) {
    ...
    public Grammar<
        ...
        return GrammarReader.parseAndSpecializeInput(
                o.toString(), properties, new GrammarToLeftRegularGrammarSpecialization<>());
    }
}
