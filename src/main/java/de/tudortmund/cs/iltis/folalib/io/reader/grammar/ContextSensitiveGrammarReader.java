 ...
 * grammar will be specialized into a type 1 grammar in the chomsky hierarchy.
 *
 ...
 * grammar failed.
 */
public class ContextSensitiveGrammarReader
        implements Reader<
                Grammar<IndexedSymbol, IndexedSymbol, Production<IndexedSymbol, IndexedSymbol>>> {

    private GrammarReaderProperties properties;

    public ContextSensitiveGrammarReader(GrammarReaderProperties properties) {
        Objects.requireNonNull(properties);
        this.properties = properties;
    }

    @Override
    public Grammar<IndexedSymbol, IndexedSymbol, Production<IndexedSymbol, IndexedSymbol>> read(
            Object o) throws IncorrectParseInputException {
        return GrammarReader.parseAndSpecializeInput(
                o.toString(), properties, new GrammarToContextSensitiveGrammarSpecialization<>());
    }
}
