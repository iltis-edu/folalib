 ...
 * grammar will be specialized into a type 0 grammar in the chomsky hierarchy.
 *
...
public class C0GrammarReader
    ...
    public Grammar<IndexedSymbol, IndexedSymbol, Production<IndexedSymbol, IndexedSymbol>> read(
        ...
        return GrammarReader.parseAndSpecializeInput(
                o.toString(), properties, new GrammarToC0GrammarSpecialization<>());
    }
}
