 ...
 * grammar will be specialized into a type 3 grammar in the chomsky hierarchy.
 *
 ...
 * grammar failed.
 */
public class RightRegularGrammarReader
        implements Reader<
                Grammar<
                        IndexedSymbol,
                        IndexedSymbol,
                        RightRegularProduction<IndexedSymbol, IndexedSymbol>>> {

    private GrammarReaderProperties properties;

    public RightRegularGrammarReader(GrammarReaderProperties properties) {
    ...
    public Grammar<
        ...
        return GrammarReader.parseAndSpecializeInput(
                o.toString(), properties, new GrammarToRightRegularGrammarSpecialization<>());
    }
}
