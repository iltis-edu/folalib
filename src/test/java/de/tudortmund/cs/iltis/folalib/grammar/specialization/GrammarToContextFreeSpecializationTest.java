...
public class GrammarToContextFreeSpecializationTest {
    ...
    public void testFaults() {
                                ...
                                new Production<>(
                                        ...
                                        new SententialForm<>(
                                                ...
                                                new GrammarSymbol.NonTerminal<>(
                                                        'C'))), // Also, not only one non-terminal
                                new Production<>(
                                        new SententialForm<>(
                                                new GrammarSymbol.NonTerminal<>('A'),
                                                new GrammarSymbol.NonTerminal<>('B')),
                                        new SententialForm<>()), // Epsilon rules are allowed
                                new Production<>(
        ...
        GrammarConstructionFaultCollection resultErr =
                new GrammarToContextFreeGrammarSpecialization<Character, Character>()
                        .specialize(grammar)
                        .unwrapErr();
